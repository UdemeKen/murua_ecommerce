                                ...
                                >
                                    ...
                                    <td>
                                        <div className='flex justify-center items-center border border-gray-200 rounded-[200px] w-[90px] p-[2px]'>
                                            <button onClick={() => decreaseQuantity(item.id)} className='text-black cursor-pointer text-xl'> - </button>
                                            <span className='px-4'>{item?.quantity}</span>
                                            <button onClick={() => increaseQuantity(item?.id)} className='text-black cursor-pointer text-xl'> + </button>
                                        </div> 
                                    </td>
