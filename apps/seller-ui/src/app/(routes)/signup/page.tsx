  ...
  return (
    <div className='w-full flex flex-col items-center pt-10 min-h-screen'>
        ...
        <div className='relative flex items-center justify-between md:w-[50%] mb-8'>
            ...
            {[1, 2, 3].map((step) => (
                <div key={ step }>
                    <div className={`w-10 h-10 flex items-center justify-center rounded-full text-white font-bold ${ step <= activeStep ? "bg-green-600" : "bg-gray-300"}` }>
                        { step }
                    </div>
